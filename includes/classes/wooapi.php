...
class WooAPI extends \PriorityAPI\API
{
    ...
    private function __construct()
    {
	    ...
	    add_action( 'sync_attachments', [$this,''] );
    ...
    private function backend()
    {
        ...
        add_filter(
            ...
            function ($columns) {
	            ...
	            $columns['branch_title'] = '<span>' . __('Branch Title', 'woocommerce') . '</span>'; // title
...
*/
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="text" id="priority_customer_number" name="priority_customer_number" value="<?php echo esc_attr($priority_customer_number); ?>" class="regular-text" />
            </td>
        </tr>
    </table>
<?php
